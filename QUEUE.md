...
| SPEC_GODOT.md AC-72 wording update | done | 2026-05-26 | AC-72 + AC-73 rewritten for structural parity (histogram + canonical TC + ±25% resource counts). AC-51 also revised — same MT-vs-PCG rationale retires its "byte-for-byte first 20 tile placements" clause. Section 15 step 8 updated. Stale comments in test files left in place (they correctly note the original wording is retired). |
