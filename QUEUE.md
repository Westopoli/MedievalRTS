...
| Cross-test sys.modules pollution cleanup | open | — | Wave-1 leaf tests inject stubs that leak. `pytest tests/` full collection fails. Run per-file as workaround. Fix: add teardown to wave-1 fixtures. |
